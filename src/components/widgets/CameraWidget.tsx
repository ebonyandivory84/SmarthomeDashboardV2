...
export function CameraWidget({
  ...
  const fullscreenWebrtcUrl = (config.fullscreenWebrtcUrl || "").trim() || null;
  const previewSourceMode = "snapshot" as const;
  const requestedFullscreenSourceMode = config.fullscreenSourceMode || (fullscreenWebrtcUrl ? "webrtc" : fullscreenFmp4Url ? "fmp4" : "flv");
  ...
  }, [config.id, previewFeed?.kind, releaseMedia]);
...
function resolveSourceMode(
  sourceMode: CameraWidgetConfig["fullscreenSourceMode"],
  snapshotUrl: string | null,
  mjpegUrl: string | null,
  flvUrl: string | null,
  fmp4Url: string | null,

...
export function buildWidgetTemplate(
  ...
  if (type === "roomSensorHistory") {
    return {
      id: `room-sensor-history-${suffix}`,
      type: "roomSensorHistory",
      title: `Raumsensoren ${suffix}`,
      rooms: [
        {
          label: "Bad Eltern",
  ...
  if (type === "heatingV2") {
    ...
    return {
      ...
      roomTempStateId: isV2 ? HEATING_V2_STATE_DEFAULTS.roomTemp : LEGACY_HEATING_STATE_DEFAULTS.roomTemp,
      ...(isV2 ? { stateDefaultsVersion: HEATING_V2_STATE_DEFAULTS_VERSION } : {}),
      ...
      dhwTempStateId: isV2 ? HEATING_V2_STATE_DEFAULTS.dhwTemp : LEGACY_HEATING_STATE_DEFAULTS.dhwTemp,
